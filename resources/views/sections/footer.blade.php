<footer>
  <div class="container footer-logo">
    <a class="navbar-brand" href="{{ home_url('/') }}">
      ...
      {{-- <img src="@asset('images/denver-shade-company-footer-logo.svg')" alt="The Denver Shade Company Footer Logo" width="308" height="34"> --}}
    </a>
  </div>
    ...
    if ( $location_one->have_posts() ) : @endphp
      @php while ( $location_one->have_posts() ) : $location_one->the_post() @endphp
        ...
        <p class="office-phone">
          <span>Office:</span> <a href="tel:{{ the_field('office_phone') }}">{{ the_field('office_phone') }}</a>
        </p>
        <p class="office-phone">
          <span>Mobile:</span> <a href="tel:{{ the_field('office_cell') }}">{{ the_field('office_cell') }}</a>
        </p>
        </div>
      @php endwhile @endphp
    @php else : @endphp
    ...
    <div class="footer-col-2">
      ...
      <div class="footer-social">
        ...
        <a href="{{ the_field('youtube_url', 'option') }}" target="_blank" rel="noopener">
          <img src="@asset('images/icon-mobile-youtube.svg')" width="30" height="30" alt="Youtube Logo">
        </a>
      </div>
    </div>
    @php $args = array(
